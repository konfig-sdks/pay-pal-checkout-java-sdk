 ...
 */
@ApiModel(description = "Resource consolidating common request and response attributes for vaulting PayPal Wallet.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class VaultPaypalWalletBase {
 ...
 public enum CustomerTypeEnum {
  ...
  public VaultPaypalWalletBase() {
  }

  public VaultPaypalWalletBase storeInVault(StoreInVaultInstruction storeInVault) {
  ...
  **/
  ...
  public VaultPaypalWalletBase description(String description) {
  ...
  **/
  ...
  public VaultPaypalWalletBase usagePattern(UsagePatternEnum usagePattern) {
  ...
  **/
  ...
  public VaultPaypalWalletBase shipping(ShippingDetail shipping) {
  ...
  **/
  ...
  public VaultPaypalWalletBase usageType(UsageTypeEnum usageType) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The usage type associated with the PayPal payment token.")
  ...
  public VaultPaypalWalletBase ownerId(Object ownerId) {
  ...
  **/
  ...
  public VaultPaypalWalletBase customerType(CustomerTypeEnum customerType) {
  ...
  **/
  ...
  public VaultPaypalWalletBase permitMultiplePaymentTokens(Boolean permitMultiplePaymentTokens) {
  ...
  **/
   ...
   * @return the VaultPaypalWalletBase instance itself
   */
  public VaultPaypalWalletBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    VaultPaypalWalletBase vaultPaypalWalletBase = (VaultPaypalWalletBase) o;
    return Objects.equals(this.storeInVault, vaultPaypalWalletBase.storeInVault) &&
        Objects.equals(this.description, vaultPaypalWalletBase.description) &&
        Objects.equals(this.usagePattern, vaultPaypalWalletBase.usagePattern) &&
        Objects.equals(this.shipping, vaultPaypalWalletBase.shipping) &&
        Objects.equals(this.usageType, vaultPaypalWalletBase.usageType) &&
        Objects.equals(this.ownerId, vaultPaypalWalletBase.ownerId) &&
        Objects.equals(this.customerType, vaultPaypalWalletBase.customerType) &&
        Objects.equals(this.permitMultiplePaymentTokens, vaultPaypalWalletBase.permitMultiplePaymentTokens)&&
        Objects.equals(this.additionalProperties, vaultPaypalWalletBase.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(storeInVault, description, usagePattern, shipping, usageType, ownerId, customerType, permitMultiplePaymentTokens, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class VaultPaypalWalletBase {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to VaultPaypalWalletBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!VaultPaypalWalletBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in VaultPaypalWalletBase is not found in the empty JSON string", VaultPaypalWalletBase.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : VaultPaypalWalletBase.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!VaultPaypalWalletBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'VaultPaypalWalletBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<VaultPaypalWalletBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(VaultPaypalWalletBase.class));

       return (TypeAdapter<T>) new TypeAdapter<VaultPaypalWalletBase>() {
           @Override
           public void write(JsonWriter out, VaultPaypalWalletBase value) throws IOException {
           ...
           @Override
           public VaultPaypalWalletBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             VaultPaypalWalletBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of VaultPaypalWalletBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of VaultPaypalWalletBase
  * @throws IOException if the JSON string is invalid with respect to VaultPaypalWalletBase
  */
  public static VaultPaypalWalletBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, VaultPaypalWalletBase.class);
  }

 /**
  * Convert an instance of VaultPaypalWalletBase to an JSON string
  *
  * @return JSON string
  */
