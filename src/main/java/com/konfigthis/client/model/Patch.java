 ...
 */
@ApiModel(description = "The JSON patch object to apply partial updates to resources.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Patch {
  /**
   * The operation.
   */
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The operation.")
  ...
  **/
  ...
  @ApiModelProperty(value = "The <a href=\"https://tools.ietf.org/html/rfc6901\">JSON Pointer</a> to the target document location at which to complete the operation.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The value to apply. The <code>remove</code>, <code>copy</code>, and <code>move</code> operations do not require a value. Since <a href=\"https://www.rfc-editor.org/rfc/rfc69021\">JSON Patch</a> allows any type for <code>value</code>, the <code>type</code> property is not specified.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The <a href=\"https://tools.ietf.org/html/rfc6901\">JSON Pointer</a> to the target document location from which to move the value. Required for the <code>move</code> operation.")
   ...
   * @return the Patch instance itself
   */
  public Patch putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.op, patch.op) &&
        ...
        Objects.equals(this.additionalProperties, patch.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Patch
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Patch.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Patch.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Patch>() {
           ...
           public Patch read(JsonReader in) throws IOException {
             ...
             Patch instance = thisAdapter.fromJsonTree(jsonObj);
