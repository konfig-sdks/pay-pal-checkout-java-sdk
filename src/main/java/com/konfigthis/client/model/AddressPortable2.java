...
public class AddressPortable2 {
  ...
  private AddressDetailsProperty1 addressDetails;

  public AddressPortable2() {
  }

  public AddressPortable2 addressLine1(String addressLine1) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The first line of the address, such as number and street, for example, `173 Drury Lane`. Needed for data entry, and Compliance and Risk checks. This field needs to pass the full address.")
  ...
  public AddressPortable2 addressLine2(String addressLine2) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The second line of the address, for example, a suite or apartment number.")
  ...
  public AddressPortable2 addressLine3(String addressLine3) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The third line of the address, if needed. Examples include a street complement for Brazil, direction text, such as `next to Walmart`, or a landmark in an Indian address.")
  ...
  public AddressPortable2 adminArea4(String adminArea4) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The neighborhood, ward, or district. This is smaller than `admin_area_level_3` or `sub_locality`. Value is:<ul><li>The postal sorting code that is used in Guernsey and many French territories, such as French Guiana.</li><li>The fine-grained administrative levels in China.</li></ul>")
  ...
  public AddressPortable2 adminArea3(String adminArea3) {
  ...
  **/
  ...
  public AddressPortable2 adminArea2(String adminArea2) {
  ...
  **/
  ...
  public AddressPortable2 adminArea1(String adminArea1) {
  ...
  **/
  ...
  public AddressPortable2 postalCode(String postalCode) {
  ...
  **/
  ...
  public AddressPortable2 countryCode(String countryCode) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The [2-character ISO 3166-1 code](https://raw.githubusercontent.com) that identifies the country or region.<blockquote><strong>Note:</strong> The country code for Great Britain is <code>GB</code> and not <code>UK</code> as used in the top-level domain names for that country. Use the `C2` country code for China worldwide for comparable uncontrolled price (CUP) method, bank card, and cross-border transactions.</blockquote>")
  ...
  public AddressPortable2 addressDetails(AddressDetailsProperty1 addressDetails) {
  ...
  **/
  ...
  public AddressDetailsProperty1 getAddressDetails() {
    return addressDetails;
  }


  public void setAddressDetails(AddressDetailsProperty1 addressDetails) {
   ...
   * @return the AddressPortable2 instance itself
   */
  public AddressPortable2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AddressPortable2 addressPortable2 = (AddressPortable2) o;
    return Objects.equals(this.addressLine1, addressPortable2.addressLine1) &&
        Objects.equals(this.addressLine2, addressPortable2.addressLine2) &&
        Objects.equals(this.addressLine3, addressPortable2.addressLine3) &&
        Objects.equals(this.adminArea4, addressPortable2.adminArea4) &&
        Objects.equals(this.adminArea3, addressPortable2.adminArea3) &&
        Objects.equals(this.adminArea2, addressPortable2.adminArea2) &&
        Objects.equals(this.adminArea1, addressPortable2.adminArea1) &&
        Objects.equals(this.postalCode, addressPortable2.postalCode) &&
        Objects.equals(this.countryCode, addressPortable2.countryCode) &&
        Objects.equals(this.addressDetails, addressPortable2.addressDetails)&&
        Objects.equals(this.additionalProperties, addressPortable2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AddressPortable2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddressPortable2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddressPortable2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AddressPortable2 is not found in the empty JSON string", AddressPortable2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AddressPortable2.openapiRequiredFields) {
      ...
      if (jsonObj.get("address_details") != null && !jsonObj.get("address_details").isJsonNull()) {
        AddressDetailsProperty1.validateJsonObject(jsonObj.getAsJsonObject("address_details"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AddressPortable2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AddressPortable2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AddressPortable2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AddressPortable2.class));

       return (TypeAdapter<T>) new TypeAdapter<AddressPortable2>() {
           @Override
           public void write(JsonWriter out, AddressPortable2 value) throws IOException {
           ...
           @Override
           public AddressPortable2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AddressPortable2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AddressPortable2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AddressPortable2
  * @throws IOException if the JSON string is invalid with respect to AddressPortable2
  */
  public static AddressPortable2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AddressPortable2.class);
  }

 /**
  * Convert an instance of AddressPortable2 to an JSON string
  *
  * @return JSON string
  */
