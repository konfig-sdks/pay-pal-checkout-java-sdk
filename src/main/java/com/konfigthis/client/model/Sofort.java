 ...
 */
@ApiModel(description = "Information used to pay using Sofort.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Sofort {
  ...
  public Sofort name(String name) {
  ...
  **/
  ...
  public Sofort countryCode(String countryCode) {
  ...
  **/
  ...
  public Sofort ibanLastChars(String ibanLastChars) {
  ...
  **/
   ...
   * @return the Sofort instance itself
   */
  public Sofort putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, sofort.name) &&
        Objects.equals(this.countryCode, sofort.countryCode) &&
        Objects.equals(this.bic, sofort.bic) &&
        Objects.equals(this.ibanLastChars, sofort.ibanLastChars)&&
        Objects.equals(this.additionalProperties, sofort.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Sofort
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Sofort.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Sofort is not found in the empty JSON string", Sofort.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Sofort.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Sofort' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Sofort> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Sofort.class));

       return (TypeAdapter<T>) new TypeAdapter<Sofort>() {
           @Override
           public void write(JsonWriter out, Sofort value) throws IOException {
           ...
           @Override
           public Sofort read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Sofort instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Sofort given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Sofort
  * @throws IOException if the JSON string is invalid with respect to Sofort
  */
  public static Sofort fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Sofort.class);
  }

 /**
  * Convert an instance of Sofort to an JSON string
  *
  * @return JSON string
  */
