 ...
 */
@ApiModel(description = "Provides additional details to process a payment using a `card` that has been stored or is intended to be stored (also referred to as stored_credential or card-on-file).<br/>Parameter compatibility:<br/><ul><li>`payment_type=ONE_TIME` is compatible only with `payment_initiator=CUSTOMER`.</li><li>`usage=FIRST` is compatible only with `payment_initiator=CUSTOMER`.</li><li>`previous_transaction_reference` or `previous_network_transaction_reference` is compatible only with `payment_initiator=MERCHANT`.</li><li>Only one of the parameters - `previous_transaction_reference` and `previous_network_transaction_reference` - can be present in the request.</li></ul>")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CardStoredCredential {
  ...
  public CardStoredCredential paymentInitiator(PaymentInitiator paymentInitiator) {
  ...
  **/
  ...
  public CardStoredCredential paymentType(StoredPaymentSourcePaymentType paymentType) {
  ...
  **/
  ...
  public CardStoredCredential usage(StoredPaymentSourceUsageType usage) {
  ...
  **/
  ...
  public CardStoredCredential previousNetworkTransactionReference(NetworkTransactionReference previousNetworkTransactionReference) {
  ...
  **/
   ...
   * @return the CardStoredCredential instance itself
   */
  public CardStoredCredential putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CardStoredCredential cardStoredCredential = (CardStoredCredential) o;
    return Objects.equals(this.paymentInitiator, cardStoredCredential.paymentInitiator) &&
        Objects.equals(this.paymentType, cardStoredCredential.paymentType) &&
        Objects.equals(this.usage, cardStoredCredential.usage) &&
        Objects.equals(this.previousNetworkTransactionReference, cardStoredCredential.previousNetworkTransactionReference)&&
        Objects.equals(this.additionalProperties, cardStoredCredential.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CardStoredCredential {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CardStoredCredential
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CardStoredCredential.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CardStoredCredential is not found in the empty JSON string", CardStoredCredential.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CardStoredCredential.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CardStoredCredential.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CardStoredCredential' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CardStoredCredential> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CardStoredCredential.class));

       return (TypeAdapter<T>) new TypeAdapter<CardStoredCredential>() {
           @Override
           public void write(JsonWriter out, CardStoredCredential value) throws IOException {
           ...
           @Override
           public CardStoredCredential read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CardStoredCredential instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CardStoredCredential given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CardStoredCredential
  * @throws IOException if the JSON string is invalid with respect to CardStoredCredential
  */
  public static CardStoredCredential fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CardStoredCredential.class);
  }

 /**
  * Convert an instance of CardStoredCredential to an JSON string
  *
  * @return JSON string
  */
