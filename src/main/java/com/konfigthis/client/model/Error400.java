 ...
 */
@ApiModel(description = "Request is not well-formed, syntactically incorrect, or violates schema.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Error400 {
 ...
 public enum MessageEnum {
  ...
  public Error400 name(NameEnum name) {
  ...
  **/
  ...
  public Error400 message(MessageEnum message) {
  ...
  **/
  ...
  public Error400 details(List<ErrorDetails> details) {
  ...
  public Error400 addDetailsItem(ErrorDetails detailsItem) {
  ...
  **/
  ...
  public Error400 debugId(String debugId) {
  ...
  **/
  ...
  public Error400 links(List<ErrorLinkDescription> links) {
  ...
  public Error400 addLinksItem(ErrorLinkDescription linksItem) {
    if (this.links == null) {
  ...
  **/
   ...
   * @return the Error400 instance itself
   */
  public Error400 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, error400.name) &&
        Objects.equals(this.message, error400.message) &&
        Objects.equals(this.details, error400.details) &&
        Objects.equals(this.debugId, error400.debugId) &&
        Objects.equals(this.links, error400.links)&&
        Objects.equals(this.additionalProperties, error400.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Error400
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Error400.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Error400>() {
           ...
           public Error400 read(JsonReader in) throws IOException {
             ...
             Error400 instance = thisAdapter.fromJsonTree(jsonObj);
