 ...
 */
@ApiModel(description = "Information used to pay using iDEAL.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Ideal {
  ...
  **/
  ...
  public Ideal countryCode(String countryCode) {
  ...
  **/
  ...
  public Ideal ibanLastChars(String ibanLastChars) {
  ...
  **/
  ...
  public Ideal attributes(Object attributes) {
  ...
  **/
   ...
   * @return the Ideal instance itself
   */
  public Ideal putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Ideal ideal = (Ideal) o;
    return Objects.equals(this.name, ideal.name) &&
        Objects.equals(this.countryCode, ideal.countryCode) &&
        Objects.equals(this.bic, ideal.bic) &&
        Objects.equals(this.ibanLastChars, ideal.ibanLastChars) &&
        Objects.equals(this.attributes, ideal.attributes)&&
        Objects.equals(this.additionalProperties, ideal.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, countryCode, bic, ibanLastChars, attributes, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Ideal
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Ideal.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Ideal is not found in the empty JSON string", Ideal.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Ideal.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Ideal' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Ideal> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Ideal.class));

       return (TypeAdapter<T>) new TypeAdapter<Ideal>() {
           @Override
           public void write(JsonWriter out, Ideal value) throws IOException {
           ...
           @Override
           public Ideal read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Ideal instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Ideal given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Ideal
  * @throws IOException if the JSON string is invalid with respect to Ideal
  */
  public static Ideal fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Ideal.class);
  }

 /**
  * Convert an instance of Ideal to an JSON string
  *
  * @return JSON string
  */
