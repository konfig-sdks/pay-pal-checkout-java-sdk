 ...
 */
@ApiModel(description = "Customizes the payer experience during the approval process for the payment.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class ExperienceContextBase {
 ...
 public enum ShippingPreferenceEnum {
  ...
  public ExperienceContextBase brandName(String brandName) {
  ...
  **/
  ...
  public ExperienceContextBase locale(String locale) {
  ...
  **/
  ...
  public ExperienceContextBase shippingPreference(ShippingPreferenceEnum shippingPreference) {
  ...
  **/
  ...
  public ExperienceContextBase returnUrl(URI returnUrl) {
  ...
  **/
  ...
  public ExperienceContextBase cancelUrl(URI cancelUrl) {
  ...
  **/
   ...
   * @return the ExperienceContextBase instance itself
   */
  public ExperienceContextBase putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ExperienceContextBase experienceContextBase = (ExperienceContextBase) o;
    return Objects.equals(this.brandName, experienceContextBase.brandName) &&
        Objects.equals(this.locale, experienceContextBase.locale) &&
        Objects.equals(this.shippingPreference, experienceContextBase.shippingPreference) &&
        Objects.equals(this.returnUrl, experienceContextBase.returnUrl) &&
        Objects.equals(this.cancelUrl, experienceContextBase.cancelUrl)&&
        Objects.equals(this.additionalProperties, experienceContextBase.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(brandName, locale, shippingPreference, returnUrl, cancelUrl, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ExperienceContextBase {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ExperienceContextBase
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ExperienceContextBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ExperienceContextBase is not found in the empty JSON string", ExperienceContextBase.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ExperienceContextBase.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ExperienceContextBase' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ExperienceContextBase> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ExperienceContextBase.class));

       return (TypeAdapter<T>) new TypeAdapter<ExperienceContextBase>() {
           @Override
           public void write(JsonWriter out, ExperienceContextBase value) throws IOException {
           ...
           @Override
           public ExperienceContextBase read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ExperienceContextBase instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ExperienceContextBase given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ExperienceContextBase
  * @throws IOException if the JSON string is invalid with respect to ExperienceContextBase
  */
  public static ExperienceContextBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ExperienceContextBase.class);
  }

 /**
  * Convert an instance of ExperienceContextBase to an JSON string
  *
  * @return JSON string
  */
