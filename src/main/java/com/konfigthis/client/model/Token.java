 ...
 */
@ApiModel(description = "The tokenized payment source to fund a payment.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Token {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The PayPal-generated ID for the token.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The tokenization method that generated the ID.")
