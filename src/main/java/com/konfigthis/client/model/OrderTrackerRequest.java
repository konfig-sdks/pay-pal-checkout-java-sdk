 ...
 */
@ApiModel(description = "The tracking details of an order.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class OrderTrackerRequest {
 ...
 public enum ShipmentUploaderEnum {
  ...
  public OrderTrackerRequest transactionId(String transactionId) {
  ...
  **/
  ...
  public OrderTrackerRequest trackingNumber(String trackingNumber) {
  ...
  **/
  ...
  public OrderTrackerRequest trackingNumberType(ShipmentTrackingNumberType trackingNumberType) {
  ...
  **/
  ...
  public OrderTrackerRequest status(ShipmentTrackingStatus status) {
  ...
  **/
  ...
  public OrderTrackerRequest shipmentDate(String shipmentDate) {
  ...
  **/
  ...
  public OrderTrackerRequest carrier(ShipmentCarrier carrier) {
  ...
  **/
  ...
  public OrderTrackerRequest carrierNameOther(String carrierNameOther) {
  ...
  **/
  ...
  public OrderTrackerRequest notifyBuyer(Boolean notifyBuyer) {
  ...
  **/
  ...
  public OrderTrackerRequest lastUpdatedTime(String lastUpdatedTime) {
  ...
  **/
  ...
  public OrderTrackerRequest shipmentDirection(ShipmentDirectionEnum shipmentDirection) {
  ...
  **/
  ...
  public OrderTrackerRequest captureId(String captureId) {
  ...
  **/
  ...
  public OrderTrackerRequest notifyPayer(Boolean notifyPayer) {
  ...
  **/
  ...
  public OrderTrackerRequest items(List<TrackerItem> items) {
  ...
  public OrderTrackerRequest addItemsItem(TrackerItem itemsItem) {
    if (this.items == null) {
  ...
  **/
   ...
   * @return the OrderTrackerRequest instance itself
   */
  public OrderTrackerRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    OrderTrackerRequest orderTrackerRequest = (OrderTrackerRequest) o;
    return Objects.equals(this.transactionId, orderTrackerRequest.transactionId) &&
        Objects.equals(this.trackingNumber, orderTrackerRequest.trackingNumber) &&
        Objects.equals(this.trackingNumberType, orderTrackerRequest.trackingNumberType) &&
        Objects.equals(this.status, orderTrackerRequest.status) &&
        Objects.equals(this.shipmentDate, orderTrackerRequest.shipmentDate) &&
        Objects.equals(this.carrier, orderTrackerRequest.carrier) &&
        Objects.equals(this.carrierNameOther, orderTrackerRequest.carrierNameOther) &&
        Objects.equals(this.postagePaymentId, orderTrackerRequest.postagePaymentId) &&
        Objects.equals(this.notifyBuyer, orderTrackerRequest.notifyBuyer) &&
        Objects.equals(this.quantity, orderTrackerRequest.quantity) &&
        Objects.equals(this.trackingNumberValidated, orderTrackerRequest.trackingNumberValidated) &&
        Objects.equals(this.lastUpdatedTime, orderTrackerRequest.lastUpdatedTime) &&
        Objects.equals(this.shipmentDirection, orderTrackerRequest.shipmentDirection) &&
        Objects.equals(this.shipmentUploader, orderTrackerRequest.shipmentUploader) &&
        Objects.equals(this.captureId, orderTrackerRequest.captureId) &&
        Objects.equals(this.notifyPayer, orderTrackerRequest.notifyPayer) &&
        Objects.equals(this.items, orderTrackerRequest.items)&&
        Objects.equals(this.additionalProperties, orderTrackerRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transactionId, trackingNumber, trackingNumberType, status, shipmentDate, carrier, carrierNameOther, postagePaymentId, notifyBuyer, quantity, trackingNumberValidated, lastUpdatedTime, shipmentDirection, shipmentUploader, captureId, notifyPayer, items, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class OrderTrackerRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to OrderTrackerRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!OrderTrackerRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderTrackerRequest is not found in the empty JSON string", OrderTrackerRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderTrackerRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderTrackerRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderTrackerRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderTrackerRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderTrackerRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderTrackerRequest>() {
           @Override
           public void write(JsonWriter out, OrderTrackerRequest value) throws IOException {
           ...
           @Override
           public OrderTrackerRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             OrderTrackerRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of OrderTrackerRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of OrderTrackerRequest
  * @throws IOException if the JSON string is invalid with respect to OrderTrackerRequest
  */
  public static OrderTrackerRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderTrackerRequest.class);
  }

 /**
  * Convert an instance of OrderTrackerRequest to an JSON string
  *
  * @return JSON string
  */
