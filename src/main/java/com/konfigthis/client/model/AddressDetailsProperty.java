...
public class AddressDetailsProperty {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The first-order entity below a named building or location that represents the sub-premises. Usually a single building within a collection of buildings with a common name. Can be a flat, story, floor, room, or apartment.")
