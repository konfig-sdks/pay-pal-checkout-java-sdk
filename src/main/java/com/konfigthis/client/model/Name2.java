...
public class Name2 {
  ...
  **/
  ...
  public Name2 surname(String surname) {
  ...
  **/
   ...
   * @return the Name2 instance itself
   */
  public Name2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Name2 name2 = (Name2) o;
    return Objects.equals(this.prefix, name2.prefix) &&
        Objects.equals(this.givenName, name2.givenName) &&
        Objects.equals(this.surname, name2.surname) &&
        Objects.equals(this.middleName, name2.middleName) &&
        Objects.equals(this.suffix, name2.suffix) &&
        Objects.equals(this.fullName, name2.fullName)&&
        Objects.equals(this.additionalProperties, name2.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(prefix, givenName, surname, middleName, suffix, fullName, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Name2>() {
           ...
           public Name2 read(JsonReader in) throws IOException {
             ...
             Name2 instance = thisAdapter.fromJsonTree(jsonObj);
